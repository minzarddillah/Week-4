...
function kaliTerusRekursif(angka) {
  ...
  if(String(angka).length === 1){
    ...
    var newNum = Number(newStr[newStr.length-1])
    var result = kaliTerusRekursif(num)
    return kaliTerusRekursif(result * newNum)
  }
}

// TEST CASES
console.log(kaliTerusRekursif(66)); // 8 prosesnya 6*6 = 36, 3*6 = 18, 1*8 = 8
